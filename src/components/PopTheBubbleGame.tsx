                ...
                return (
                    ...
                    >
                        <svg viewBox="0 0 200 200" className={`w-40 h-40 md:w-56 md:h-56 ${isPopping || shouldClear ? 'animate-pop-bubble' : ''}`}>
                            ...
                            <circle cx="100" cy="100" r="80" stroke="rgba(255, 255, 255, 0.5)" strokeWidth="3" fill="none" />
                            {/* The classic sharp reflection */}
                            <path d="M 65 75 A 35 35 0 0 1 100 60" stroke="white" strokeWidth="5" fill="none" opacity="0.8"/>
                        </svg>
