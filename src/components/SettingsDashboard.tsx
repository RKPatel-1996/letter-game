    ...
    <div className="min-h-screen bg-slate-200 p-4 sm:p-8 font-sans">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={() => dispatch({ type: "EXIT_TO_GAME" })}
            className="px-4 py-2 sm:px-6 sm:py-3 bg-red-500 text-white font-semibold rounded-lg shadow-md hover:bg-red-600 transition-colors"
          >
            Lock & Exit
          </button>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md mb-6">
          ...
          <p className="text-gray-600 mb-4">
            Choose how many options your child sees at one time.
          </p>
