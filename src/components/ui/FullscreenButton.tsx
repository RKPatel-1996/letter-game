...
const FullscreenButton: FC = () => {
  ...
  return (
    <button
      ...
      className="absolute top-4 right-20 bg-blue-500 text-white p-2 rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 z-50"
    >
      {isFullscreen ? (
        <svg
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M4 8V4m0 0h4M4 4l5 5m7 2l5-5m0 0h-4m4 0v4M4 16v4m0 0h4m-4 0l5-5m7 2l5 5m0 0h-4m4 0v-4"
          />
        </svg>
      )}
    </button>
